package com.jrhub.api.infrastructure.telemetry;
...
@Service
@Slf4j
public class MetricsGeneratorService implements MetricsService {
    ...
    public MetricsGeneratorService(MeterRegistry meterRegistry, Tracer tracer) {
        this.tracer = tracer;
