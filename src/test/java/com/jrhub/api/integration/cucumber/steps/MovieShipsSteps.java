...
public class MovieShipsSteps {
    ...
    public void existSpaceShipById(long shipId) throws Exception {
        System.out.println("Ejecutado el GIVEN - Testing ship with ID: " + shipId);
    ...
    public void elUsuarioConsultaLosDetallesDelUsuarioConID(long shipId) throws Exception {
        System.out.println("Ejecutado el WHEN - Consultando ship con ID: " + shipId);
    ...
    public void seMuestranLosDetallesDelUsuario() throws JsonProcessingException {
        System.out.println("Ejecutado el THEN - Verificando detalles de la nave");
        ...
        assertThat("El ID no debe ser nulo", resultMovieSpaceShipsDto.getId(), is(notNullValue()));
        assertThat("El nombre no debe ser nulo", resultMovieSpaceShipsDto.getName(), is(notNullValue()));
        assertThat("La película no debe ser nula", resultMovieSpaceShipsDto.getMovie(), is(notNullValue()));
        
        System.out.println("Nave encontrada: " + resultMovieSpaceShipsDto.getName() + 
                          " de la película " + resultMovieSpaceShipsDto.getMovie());
    }

    @Given("no existe una nave espacial con el ID {long}")
    public void noExistSpaceShipById(long shipId) throws Exception {
        System.out.println("Ejecutado el GIVEN - Verificando que NO existe ship con ID: " + shipId);
    ...
    public void seMuestraUnErrorDeNaveNoEncontrada() {
        System.out.println("Ejecutado el THEN - Verificando error 404");
